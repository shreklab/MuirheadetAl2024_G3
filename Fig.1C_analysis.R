########### FIG 1C ANALYSIS ###########
## Description:
##    glycerol avoidance for both nrx and nlg mutants and double mutant 
##
...
setwd("/Users/carolinemuirhead/Desktop/Data/Colab/ R data analysis/Fig. 1/C")

source("customfunctions.R")

datafile="Fig.1C_analysis.xlsx"
outputprefix="Fig.1C_analysis"
