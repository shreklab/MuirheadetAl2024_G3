########### FIG 1E ANALYSIS ###########
## Description:
##    quinine avoidance for both nrx and nlg mutants and double mutant 
##
...
setwd("/Users/carolinemuirhead/Desktop/Data/Colab/ R data analysis/Fig. 1/E")

source("customfunctions.R")

datafile="Fig.1E_analysis.xlsx"
outputprefix="Fig.1E_analysis"
