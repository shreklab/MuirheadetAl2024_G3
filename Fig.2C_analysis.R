########### FIG 2C ANALYSIS ###########
## Description:
##    Glycerol avoidance in wy778 mutants, short iso (M. Hart lab),
##                  and long iso (S. Chalasani lab) rescues
##
...
setwd("/Users/carolinemuirhead/Desktop/Data/Colab/ R data analysis/Fig. 2/C")

source("customfunctions.R")

datafile="Fig.2C_analysis.xlsx"
outputprefix="Fig.2C_analysis"
...
d$strain = factor(d$strain,
                  levels=c("N2","TV13570","IV891","MPH15"))
...
cX = as.data.frame(read_xlsx(paste0(
                    outputprefix,"_posthocdesign.xlsx"),sheet = "Sheet2"))
