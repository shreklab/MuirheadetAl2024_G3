########### FIG 2D ANALYSIS ###########
## Description:
##    Glycerol avoidance in wy1155 mutants, short iso rescues
##
...
setwd("/Users/carolinemuirhead/Desktop/Data/Colab/ R data analysis/Fig. 2/D")

source("customfunctions.R")

datafile="Fig.2D_analysis.xlsx"
outputprefix="Fig.2D_analysis"
