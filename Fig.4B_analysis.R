########### FIG 4B ANALYSIS ###########
## Description:
##    L3 N2 and nrx mutants (wy778, wy1155, nu485, kur7) glycerol avoidance  
##
...
setwd("/Users/carolinemuirhead/Desktop/Data/Colab/ R data analysis/Fig. 4/B")

source("customfunctions.R")

datafile="Fig.4B_analysis.xlsx"
outputprefix="Fig.4B_analysis"
