########### FIG 4C ANALYSIS ###########
## Description:
##    L4 N2 and nrx mutants (wy778, wy1155, nu485, kur7) glycerol avoidance  
##
...
setwd("/Users/carolinemuirhead/Desktop/Data/Colab/ R data analysis/Fig. 4/C")

source("customfunctions.R")

datafile="Fig.4C_analysis.xlsx"
outputprefix="Fig.4C_analysis"
...
d$strain = factor(d$strain,
                  levels=c("N2","TV22998","TV13570", "PTK69","TV22997"))
